...
GLuint ShaderTools::InitializeShaders(const std::string vsFile, const std::string fsFile) {
	// load shader source from files
	std::string vertexSource = LoadSource(vsFile);
	std::string fragmentSource = LoadSource(fsFile);
